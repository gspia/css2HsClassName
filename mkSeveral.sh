...
./result/bin/css2HsClassName Bulma "" theme < css/bulma.css > res/Bulma.hs

# Icon-sets


./result/bin/css2HsClassName Elusive el icon < css/elusive-icons.css > res/Elusive.hs
./result/bin/css2HsClassName FA fa icon < css/fontawesome.css > res/FA.hs
...
./result/bin/css2HsClassName OpenIconicBS oi icon < css/open-iconic-bootstrap.css > res/OpenIconicBS.hs
./result/bin/css2HsClassName OpenIconic oi icon < css/open-iconic.css > res/OpenIconic.hs
